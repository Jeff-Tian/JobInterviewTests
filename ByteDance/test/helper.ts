...
export const nodeValueOf = (fn: (...args: any[]) => ListNode | null) =>
  compose((n: ListNode | null) => (n ? n.val : null), fn);

export const testCases = (fn: Function) => (
  cases: Array<{ expected: number | null; input: any[] }>
