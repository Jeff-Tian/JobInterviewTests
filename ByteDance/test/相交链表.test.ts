...
describe('创建相交链表', () => {
    it('[4,1,8,4,5], [5,0,1,8,4,5], 2, 3', () => {
        const listA = [4, 1, 8, 4, 5], listB = [5, 0, 1, 8, 4, 5], skipA = 2, skipB = 3
    ...
    it('[0, 9, 1, 2, 4], [3, 2, 4], 3, 1', () => {
        const [a, b] = ListNode.createIntersectedLinks([0, 9, 1, 2, 4], [3, 2, 4], 3, 1);
...
testCases(nodeValueOf(getIntersectionNode))([{
    expected: 8,
    input: ListNode.createIntersectedLinks([4, 1, 8, 4, 5], [5, 0, 1, 8, 4, 5], 2, 3)
}, {
    expected: 2,
